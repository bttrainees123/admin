...
import { validateLocalEmail } from '../utils/validation'
...
const LoginPage = () => {
  ...
  const handleRegOpen = () => setRegShow(true)
  ...
  const validatePasswordLog = (password) => validateField(password, /^[a-zA-Z0-9!@#$%^&*]{6,16}$/, 'password-error');
  ...
  const loginHandler = (e) => {
    ...
    if (validateEmailLog(email) && validatePasswordLog(password)) {
      users?.forEach((val) => {
        if (val.email === email) {
          emailCheck = true;
        }
  ...
  return (
    <section className="sign_in p-0">
      <div className="container-fluid">
                ...
                <div className="row">
                  ...
                  <div>
                    <p className="mt-10 text-center text-sm/6 text-gray-500">
                      ...
                      <NavLink className="font-semibold text-indigo-600 hover:text-indigo-500" onClick={handleRegOpen}>
                        SignUp now
                      </NavLink>
                    </p>
                  </div>
        ...
        <Modal show={regShow} onHide={handleRegClose} className='modalSize'
          size='md'
          centered
        >
          <Modal.Header closeButton>
            <Modal.Title id="contained-modal-title-vcenter">Register here
            </Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <Form>
              <Form.Group className="mb-3 col" controlId="exampleForm.ControlInput1">
                ...
                >
                  ...
                  />
                  <span id='email-err' style={{ display: "none", color: 'red' }}>Enter valid Email</span>
              ...
              <Form.Group className="mb-3 col" controlId="exampleForm.ControlInput1">
                ...
                >
                  <Form.Control
                    type='text' value={password} onChange={(e) => setPassword(e.target.value)} onInput={validatePassword}
                  />
                  <span id='reg-password-error' style={{ display: "none", color: 'red' }}>Enter valid password</span>
